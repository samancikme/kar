      ...
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between h-16 md:h-20">
          <Link href="/" className="flex items-center space-x-2">
            ...
            <span className="font-heading font-bold text-xl text-primary">Karpage</span>
          </Link>
          ...
          <nav className="hidden md:flex items-center space-x-8">
            ...
            <Link href="#contact" className="text-foreground/70 hover:text-primary font-medium transition-colors">
              {t("common.contact")}
            </Link>
          </nav>
          ...
          >
            <div className="container mx-auto px-4 py-4 flex flex-col space-y-4">
              ...
              <Link
                href="/courses"
                className={`${
                  pathname.includes("/courses") ? "text-primary" : "text-foreground/70"
                } hover:text-primary font-medium py-2 transition-colors`}
                onClick={() => setIsMenuOpen(false)}
              >
                {t("common.courses")}
              ...
              <Link
                href="/news"
                className={`${
                  pathname.includes("/news") ? "text-primary" : "text-foreground/70"
                } hover:text-primary font-medium py-2 transition-colors`}
                onClick={() => setIsMenuOpen(false)}
              >
                {t("common.news")}
